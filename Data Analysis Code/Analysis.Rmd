...
Compare the three scores across three stages in 2 groups. 
```{r}
# Control Group
...
# p-value in Pre-Season and Post-Season are significantly different 
# No significance found at the stage of Mid-Season. 
```
